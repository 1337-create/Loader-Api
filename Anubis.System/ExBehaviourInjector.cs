...
using Anubis.System.Exceptions;
using System;
...
{
    internal static class ExBehaviourInjector
    {
        ...
        public static void Inject(ExObject obj, Type[] requires)
        {
            foreach(var require in requires)
            {
                ...
                {
                    throw new BehaviourInjectorException( $"{MethodBase.GetCurrentMethod().Name}: Can't inject required component '{require.FullName}'. Method 'AddComponentByTypeInstance_Internal' not found!" );
                }
            }
        }
